package com.gilsur.optimasitersseract.Core.ExtraViews;
...
import com.gilsur.optimasitersseract.R;
...
public class FocusBoxView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(frame.left - 16, frame.top - 16, 16, paint);
        canvas.drawCircle(frame.right + 16, frame.top - 16, 16, paint);
        canvas.drawCircle(frame.left - 16, frame.bottom + 16, 16, paint);
        canvas.drawCircle(frame.right + 16, frame.bottom + 16, 16, paint);
